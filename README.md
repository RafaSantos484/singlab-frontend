...
│   ├── transcription/       # Whisper worker and transcription types/constants
...
Without this, playback still works and microphone tracking remains available,
but vocals-stem waveform analysis is unavailable.
